...
export const products: Record<string, ProductEntry> = {
  "xoai-tu-quy": {
    ...
    heroImage: "/images/xoai-17-04/xoai-tu-quy-vip-trai-to-cuong-la-tay-cam.jpg",
    heroImageAlt: "Xoài Tứ Quý Thạnh Phú Bến Tre — trái to còn cuống lá tươi, tay cầm tại vựa",
    season: [4, 5, 6, 7, 8],
    status: "active",
    order: 1,
    seo: {
